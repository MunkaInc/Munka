    ...
    <body class="index-bg">
        ...
        <div class="banner-row">
            <div class="container">
                <div class="row">
                    <div class="col s12">
                        <h5 class="center central">"Nunca foi tão fácil <br> cuidar do que é nosso."</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col s4">
                        <div class="icon-block">
                            <h3 class="center blue-text"><img src="images/ferramenta_ico.png" alt="ferramentas" class="img_icon_main"></h3>
                    ...
                    <div class="col s4">
                        <div class="icon-block">
                            <h3 class="center blue-text"><img src="images/muro_ico.png" alt="muro em construção" class="img_icon_main"></h3>
                            <h5 class="center">ESTAMOS SEMPRE <br> PERTO DE VOCÊ</h5>
                    ...
                    <div class="col s4">
                        <div class="icon-block">
                            <h3 class="center blue-text"><img src="images/pintor_ico.png" alt="Pincel" class="img_icon_main"></h3>
                            <h5 class="center">ESTAMOS SEMPRE <br> PERTO DE VOCÊ</h5>
